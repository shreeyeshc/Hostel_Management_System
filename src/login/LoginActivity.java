 ...
 import adminlogin.AdminloginActivity;
...
public class LoginActivity extends JFrame
 {
    ...
    public void initComponents() {
	   ...
	   setExtendedState(JFrame.MAXIMIZED_BOTH);  // code for full screen size
        ...
        jButton3.setBounds(350, 610, 90, 40);
        

		//icon label
        jLabel1.setFont(new java.awt.Font("Dialog", 1, 14)); 
        jLabel1.setIcon(new javax.swing.ImageIcon("src\\images\\hh.png")); 
    ...
    public void jButton1ActionPerformed(ActionEvent evt) {                                         
        try{
			...
			ResultSet rs = st.executeQuery("select * from h_user");
