...
package adminsignup;
import Adminloginconfirm.AdminloginConfirmActivity;
...
public class AdminsignupActivity extends JFrame implements ActionListener
 {

    public AdminsignupActivity() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminsignupActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
			...
			
			{
				try
				{
					...
					Connection con = DriverManager.getConnection("jdbc:mysql://www.papademas.net:3307/510fp?autoReconnect=true&useSSL=false","fp510","510");
				        ...
				        PreparedStatement ps=con.prepareStatement("insert into h_admin values(?,?,?)");
                        ps.setString(1, n);
                        ps.setString(2, p);
                        ps.setString(3, em);
                        ...
                        if(a>0)
                        {
                          JOptionPane.showMessageDialog(this,"Admin Successfully signup!");
