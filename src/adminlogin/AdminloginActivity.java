...
import adminsignup.AdminsignupActivity;
 
 import java.sql.*;
 import java.awt.*;
 import javax.swing.*;
 import java.awt.event.*;
public class AdminloginActivity extends JFrame
 {
    ...
    public void jButton1ActionPerformed(ActionEvent evt) {                                         
        try{
			...
			ResultSet rs = st.executeQuery("select * from h_admin");
//                        JOptionPane.showMessageDialog(this, "test");
    ...
    public void jButton2ActionPerformed(java.awt.event.ActionEvent evt) { 
       ...
       new AdminsignupActivity().setVisible(true);
		this.setVisible(false);	
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminloginActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminloginActivity().setVisible(true);
            }
        });
    }
